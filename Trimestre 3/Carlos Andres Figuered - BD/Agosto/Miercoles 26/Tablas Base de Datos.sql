...
-- SCRIPT DE ACTUALIZACIÓN A LA B.D.
-- 1. Forzar empates exactos en fechas de nacimiento para ver RANK vs DENSE_RANK
update pacientes set fecha_nacimiento = '1990-06-30' where id_paciente in (5, 6);
update pacientes set fecha_nacimiento = '1995-11-23' where id_paciente in (8, 9, 10);

-- 2. Asignar citas consecutivas al Paciente 1 para evidenciar LAG, LEAD y cálculo de días
insert into citas (id_paciente, id_medico, fecha_hora, estado) values
(1, 1, '2026-06-15 08:00:00', 'Completada'),
(1, 2, '2026-07-01 10:00:00', 'Completada'),
(1, 1, '2026-07-20 11:30:00', 'Programada');

-- 3. Crear empates claros de volumen de citas por médico (Médico 1=7 citas, Médicos 2 y 3=5 citas cada uno)
insert into citas (id_paciente, id_medico, fecha_hora, estado) values
(3, 1, '2026-06-10 09:00:00', 'Completada'),
(4, 2, '2026-06-11 11:00:00', 'Completada'),
(5, 3, '2026-06-12 14:00:00', 'Completada');

-- 4. Agregar columna de costo por consulta en la especialidad
alter table especialidades
add column costo decimal(10,2) not null default 50000.00;

-- 5. Asignar tarifas reales según la especialidad
update especialidades set costo = 50000.00 where id_especialidad = 1; -- Medicina General
update especialidades set costo = 70000.00 where id_especialidad = 2; -- Pediatría
update especialidades set costo = 95000.00 where id_especialidad = 3; -- Cardiología
update especialidades set costo = 80000.00 where id_especialidad = 4; -- Dermatología
update especialidades set costo = 85000.00 where id_especialidad = 5; -- Ginecología
update especialidades set costo = 110000.00 where id_especialidad = 6; -- Neurología
update especialidades set costo = 75000.00 where id_especialidad = 7; -- Oftalmología
update especialidades set costo = 90000.00 where id_especialidad = 8; -- Psiquiatría